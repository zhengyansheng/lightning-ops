...
class TableField(BaseModel):
    # 表字段 和 验证规则
    table_classify = models.OneToOneField(
        to=TableClassify,
...
class TableData(BaseModel):
    # 表数据
    table_classify = models.ForeignKey(
        to=TableClassify, on_delete=models.CASCADE, verbose_name="关联Classify"
    )
...
class AssetsRelation(BaseModel):
    ...
    table_relation = models.ForeignKey(
        to=TableRelation, on_delete=models.CASCADE, verbose_name="表关系"
    )
